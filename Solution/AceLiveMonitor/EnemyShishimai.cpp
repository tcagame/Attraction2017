...
_attack( false ) {
	...
	setPower( property->getData( "Shishimai_POWER" ) );
	setForce( property->getData( "Shishimai_FORCE" ) );
	setOverlappedRadius( property->getData( "Shishimai_RADIUS" ) );
}
...
void EnemyShishimai::setSynchronousData( int camera_pos ) const {
	const int ANIM[ ] = {
