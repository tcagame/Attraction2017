	...
	for ( int i = 0; i < OBJECT_CHIP_WIDTH_NUM; i++ ) {
		for ( int j = 0; j < OBJECT_CHIP_HEIGHT_NUM; j++ ) {
			...
			if ( _data->getObject( ox, oy ) == OBJECT_SHISHIMAI_DEMON ) {
				_enemy->setRect( RECT_SHISHIMAI_DEMON.tx, RECT_SHISHIMAI_DEMON.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
			if ( _data->getObject( ox, oy ) == OBJECT_SHISHIMAI ) {
				_enemy->setRect( RECT_SHISHIMAI.tx, RECT_SHISHIMAI.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
			...
			if ( _data->getObject( ox, oy ) == OBJECT_HAND ) {
				_enemy->setRect( RECT_HAND.tx, RECT_HAND.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
			if ( _data->getObject( ox, oy ) == OBJECT_RED_BIRD ) {
				_enemy->setRect( RECT_RED_BIRD.tx, RECT_RED_BIRD.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
			if ( _data->getObject( ox, oy ) == OBJECT_BLUE_MONK ) {
				_enemy->setRect( RECT_BLUE_MONK.tx, RECT_BLUE_MONK.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
			if ( _data->getObject( ox, oy ) == OBJECT_GREEN_ZOMBIE ) {
				_enemy->setRect( RECT_GREEN_ZOMBIE.tx, RECT_GREEN_ZOMBIE.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
			if ( _data->getObject( ox, oy ) == OBJECT_HUG_DEMON ) {
				_enemy->setRect( RECT_HUG_DEMON.tx, RECT_HUG_DEMON.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
			if ( _data->getObject( ox, oy ) == OBJECT_SWAMP_ZOMBIE_A ) {
				_enemy->setRect( RECT_SWAMP_ZOMBIE_A.tx, RECT_SWAMP_ZOMBIE_A.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
			...
			if ( _data->getObject( ox, oy ) == OBJECT_SWAMP_ZOMBIE_C ) {
				_enemy->setRect( RECT_SWAMP_ZOMBIE_C.tx, RECT_SWAMP_ZOMBIE_C.ty, NORMAL_CHAR_GRAPH_SIZE, NORMAL_CHAR_GRAPH_SIZE );
				_enemy->setPos( PREVIEW_X + i * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE / 2 ), PREVIEW_Y + j * OBJECT_CHIP_SIZE - ( NORMAL_CHAR_GRAPH_SIZE - OBJECT_CHIP_SIZE ) );
				_enemy->draw( );
			}
