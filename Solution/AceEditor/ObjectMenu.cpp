...
ObjectMenu::ObjectMenu( ImagePtr image_menu, ImagePtr image_block, ImagePtr enemy_midium_image, ImagePtr enemy_big_image, ImagePtr enemy_wide_image, ImagePtr image_event, ObjectEditorPtr object_editor ) :
_active( false ),
