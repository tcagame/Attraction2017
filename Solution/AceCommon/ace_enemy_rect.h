...
const Rect RECT_SHELL			( 6 * CHIP_SIZE, 8 * CHIP_SIZE );
const Rect RECT_WATER_GHOST		( 6 * CHIP_SIZE, 15 * CHIP_SIZE );

const Rect RECT_SKELETON		( 0 * CHIP_SIZE, 2 * CHIP_SIZE );
const Rect RECT_LADY			( 0 * CHIP_SIZE, 1 * CHIP_SIZE );
const Rect RECT_RAY				( 0 * CHIP_SIZE, 0 * CHIP_SIZE );
...
const Rect RECT_TURTLE			( 0 * CHIP_SIZE, 16 * CHIP_SIZE );

const Rect RECT_MONEY_BAG		( 0 * SMALL_CHIP_SIZE, 0 * SMALL_CHIP_SIZE );
const Rect RECT_MONEY_PURSE		( 3 * SMALL_CHIP_SIZE, 0 * SMALL_CHIP_SIZE );
const Rect RECT_MONEY_500		( 0 * SMALL_CHIP_SIZE, 2 * SMALL_CHIP_SIZE );
const Rect RECT_MONEY_1000		( 2 * SMALL_CHIP_SIZE, 2 * SMALL_CHIP_SIZE );
const Rect RECT_MONEY_5000		( 0 * SMALL_CHIP_SIZE, 1 * SMALL_CHIP_SIZE );
const Rect RECT_MONEY_10000		( 2 * SMALL_CHIP_SIZE, 1 * SMALL_CHIP_SIZE );
