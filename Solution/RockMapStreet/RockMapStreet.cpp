...
void RockMapStreet::updateStreet( ) {
	...
	for ( int i = 0; i < ROCK_PLAYER_NUM; i++ ) {
		...
		//STREET3ÇÃÉvÉåÉCÉÑÅ[Ç™Ç¢ÇÍÇŒìøÉAÉCÉeÉÄÇÉ|ÉbÉv
		if ( !_virtue_pop ) {
...
void RockMapStreet::genarateEnemies( STAGE next ) {
	...
	switch ( next ) {
	case STAGE_STREET:
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyStone      ( Vector(    300,     30, -520  ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyStone      ( Vector(   6000,     30, -2000 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyStone      ( Vector(   5000,     30, -2100 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyStone      ( Vector(   4500,     30, -2100 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyStone      ( Vector(   6000,     30, -2000 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyStone      ( Vector(   6000,     30, -2000 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(    850,     60,  -520 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   6000,     30, -2100 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   5500,      0, -2100 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   5000,    -50, -2100 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   4300,   -250, -2200 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   3400,   -568, -3120 ) ) ), true ) ) );//ç‚ÇÃê‹ÇËï‘Çµ
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   5110,   -850, -3120 ) ) ), true ) ) );//ç‚ÇÃâ∫ÇÃìπíÜêS
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   7400,   -900, -3120 ) ) ), true ) ) );//ç‚ÇÃäCéËëO
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   9090,  -1350, -2840 ) ) ), true ) ) );//äCÇÃç≈èâínì_
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(   9950,  -1380, -2843 ) ) ), true ) ) );//äCÇÃç≈èâÇ∆íÜêSÇÃä‘
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(  11000,  -1380, -2553 ) ) ), true ) ) );//äCÇÃíÜêS
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(  12220,  -1380, -2553 ) ) ), true ) ) );//äCÇÃíÜêSÇ∆ç≈å„ÇÃä‘
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(  13360,  -1380, -2003 ) ) ), true ) ) );//äCÇÃç≈å„
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(  15600,  -1380, -2843 ) ) ), true ) ) );//äCÇÃã˜Ç¡Ç±â∫
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySkeleton   ( Vector(  13080,  -1380,     0 ) ) ), true ) ) );//äCÇÃã˜Ç¡Ç±è„
		...
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyKimono     ( Vector( 12250, 60, -2320 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyFaceAndHand( Vector( 12250, 60, -2320 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyGhost		 ( Vector(  900,  60, -520 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemySmallFrog	 ( Vector( 7250,  60, -2520 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyChivil	 ( Vector( 6000,  60, -620 ) ) ), true ) ) );
		military->addPop( RockPopPtr( new RockPop( RockEnemyPtr( new RockEnemyMoth		 ( Vector( 7200,  30, -2300 ) ) ), true ) ) );
		break;
	case STAGE_CAVE:
...
void RockMapStreet::genarateEventCharacters( STAGE next ) {
	...
	case STAGE_STREET:
	{
		if ( _stage != STAGE_RYUGU ) {
			//ó≥ã{Ç©ÇÁñﬂÇ¡ÇƒÇ≠ÇÈÇ∆Ç´ÇÕãTÇèoÇ≥Ç»Ç¢ÅB
