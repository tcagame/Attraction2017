...
void RockDollHouse::initialize( ) {
	...
	_dolls[ DOLL_BOSS_TREE             ]->setScale( Matrix::makeTransformScaling( Vector( 1.5, 1.5, 1.5 ) ) );
	...
	_dolls[ DOLL_TREE_NUTS             ]->setScale( Matrix::makeTransformScaling( Vector( 1.5, 1.5, 1.5 ) ) );
