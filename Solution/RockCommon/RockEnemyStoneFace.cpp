...
RockEnemyStoneFace::RockEnemyStoneFace( const Vector& pos ) :
RockEnemy( pos, DOLL_FACE_AND_HAND, HP, 1, 10, 10, false, true ),
_player_radius( 0 ) {
}


RockEnemyStoneFace::~RockEnemyStoneFace( ) {
}

void RockEnemyStoneFace::act( ) {
...
double RockEnemyStoneFace::getAnimTime( ) const {
...
void RockEnemyStoneFace::dropItem( ) {
